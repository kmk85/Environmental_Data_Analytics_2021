...
# These points are shown with real distances, so you can see autocorrelation and other spatial patterns in the data
...
# tiles are the backgrounds; adding our data as circle markers and are specifying the characteristics of the markers; also determining what shows up in the map popup
...
# Yes, new geometry column - combined the lat and long columns
...
# dont need to specify x and y in aes b/c uses coordinates
ggplot() + 
...
# specifying color and size of points
mapview(sf_EPAair_PM_avg, 
        zcol='meanPM', 
        cex='maxPM')
...
#Extract the Durham Armory Point (creating a subset of the dataframe)
